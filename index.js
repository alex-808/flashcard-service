                ...
                items: {
                    ...
                    properties: {
                        front: {
                            type: 'string',
                            description:
                                'Front content of a flashcard containing a question',
                        },
                        back: {
                            type: 'string',
                            description:
                                'Back content of a flashcard containing the answer to the question',
                        },
                    },
                },
            },
...
const generate = async (inputText, prompt) => {
    ...
    const { flashcards } = JSON.parse(arguments);
